...
+ Configuration files locations by default are: 
   ...
   * OSX: `~/Library/Application Support/EDX/`
...
2. Using your QT wallet interface
   1.  Send - In a single Transaction - 50K EDX to the address generated in step 1.i - requires *15 confirmations*
...
4. On your desktop, edit the file named `masternode.conf` located in your EDX wallet folder; add a **SINGLE SPACED SINGLE LINE** for each of your Masternodes based on the following template : 
   ...
   **Example:** the second line is not to be included in the config file and is to assist in pointing out the source of the information
   ...
   [Sample masternode.conf](https://github.com/SaltineChips/EDX-MN/blob/master/masternode.conf)
